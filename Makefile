...
.PHONY: check-crash
check-crash: bin.tar.gz exploit-2a.py exploit-2b.py exploit-2c.py exploit-2d.py exploit-2e.py shellcode.bin
	./check-bin.sh
	tar xf bin.tar.gz
	...
	./check-part2.sh zook-exstack.conf ./exploit-2e.py
